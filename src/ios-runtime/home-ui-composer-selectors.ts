import type { FocusField, HomeDisplayMode } from '../types';

export type ComposerDisplaySelectorInput = {
  transcript: string;
...
export function resolveComposerDisplaySelectors(
  input: ComposerDisplaySelectorInput,
) {
