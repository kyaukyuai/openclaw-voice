export type SessionPanelSelectorInput = {
  isSending: boolean;
...
export function resolveSessionPanelSelectors(input: SessionPanelSelectorInput) {
...
export function resolveSettingsStatusSelectors(input: {
...
export function resolveSectionIconColors(isDarkTheme: boolean) {
  return {
