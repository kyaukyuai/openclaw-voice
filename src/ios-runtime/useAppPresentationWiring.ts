...
export function useAppPresentationWiring(input: UseAppPresentationWiringInput) {
  ...
  const { keyboardBarAnim } = useKeyboardUiRuntime({
    ...
    setKeyboardState: composerRuntime.setKeyboardState,
    setIsKeyboardBarMounted: appState.setIsKeyboardBarMounted,
  });
  ...
  return useAppViewModelWiring({
    ...
    ui: {
      ...
      toggleAuthTokenVisibility: runtimeWiring.runtimeUiHelpers.toggleAuthTokenVisibility,
      settingsReady: settings.isReady,
      isStartupAutoConnecting: appState.isStartupAutoConnecting,
